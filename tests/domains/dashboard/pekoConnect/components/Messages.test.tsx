...
describe('ChatBody Component', () => {
    ...
    it('renders grouped messages correctly', () => {
        ...
        // Uncomment if the call message has a specific rendering text
    ...
    it('highlights search terms in text messages', () => {
        ...
        // Ensure the term is highlighted (check the HTML structure, e.g., <mark> tag or specific class)
        expect(highlightedElement.innerHTML).toContain('search term');
        // Add more specific checks here if highlighting uses a particular tag or style
    });
