...
const InvoiceCard = ({
    ...
    return (
        <Flex vertical gap={5} className="w-full  justify-center items-center">
            <Typography.Text className="xs:text-lg md:text-3xl md:mt-10 md:pb-5 font-normal">
                Your invoice is generated
            </Typography.Text>
            <Card
                ref={componentRef}
                className="border border-gray-300 md:max-w-3xl p-3 rounded-md mt-6 "
            >
                <Row gutter={[0, 20]} className="w-full" align="top">
                    ...
                    <Col
                        xs={15}
                        md={16}
                        className="flex justify-between align-top self-start mt-5 gap-3 md:pr-4"
                    >
                        <Flex vertical gap={5}>
                            <Typography.Text className="font-bold md:text-sm xs:text-[0.7rem]">
                                From
                            </Typography.Text>
                            {data && (
                                <Typography.Text className="font-medium xs:text-[0.7rem] md:text-sm">
                                    {data?.recipientDetails && data?.recipientDetails?.billerName}
                                </Typography.Text>
                            )}
                            {data && (
                                <Typography.Text className="xs:text-[0.7rem] md:text-sm">
                        ...
                        <Flex vertical gap={5}>
                            <Typography.Text className="font-bold xs:text-[0.7rem] md:text-sm ">
                                Billed to
                            </Typography.Text>
                            {data && (
                                <Typography.Text className="font-medium xs:text-[0.7rem] md:text-sm">
                    ...
                    <Col xs={9} md={8} className="xs:mt-4 md:mt-10">
                        <Flex vertical gap={10}>
                            <Flex gap={10} justify="space-between">
                                <Typography.Text className="font-normal xs:text-[0.7rem] md:text-sm">
                                    Invoice No
                                </Typography.Text>
                                {data && (
                                    <Typography.Text className="font-medium xs:text-[0.7rem] md:text-sm">
                    ...
                    <Flex justify="end" className="mt-8">
                        <Flex vertical gap={10}>
                            <Flex gap={140} justify="space-between" className="md:px-2">
                                <Typography.Text className="font-medium">Sub Total</Typography.Text>

                                <Typography.Text className="xs:text-[0.7rem] md:text-sm font-semibold">
                            ...
                            <Flex gap={140} justify="space-between" className="md:px-2">
                                ...
                                <Typography.Text className="xs:text-[0.7rem] md:text-sm font-semibold">
                                    AED {data?.paymentDetails?.vat ? data?.paymentDetails?.vat : 0}
                                </Typography.Text>
                            </Flex>
                            <Divider className="m-0 p-0" />
                            <Flex gap={140} justify="space-between" className="md:px-2">
                                <Typography.Text className="font-medium">Discount</Typography.Text>
                            ...
                            <Divider className="m-0 p-0" />
                            <Flex gap={140} justify="space-between" className="md:px-2">
                                <Typography.Text className="font-medium">Shipping</Typography.Text>
                            ...
                            <Flex gap={140} justify="space-between" className="md:px-2">
                                ...
                                <Typography.Text className="xs:text-[0.7rem] md:text-sm font-semibold">
                                    ...
                                    {parseFloat(data?.paymentDetails?.amountPaid)
                                        ? parseFloat(data?.paymentDetails?.amountPaid).toFixed(2)
                                        : '0.00'}
                                </Typography.Text>
                            </Flex>
                            <Flex
                            ...
                            >
                                ...
                                <Typography.Text className="xs:text-[0.7rem] md:text-sm font-semibold text-navTextColor">
