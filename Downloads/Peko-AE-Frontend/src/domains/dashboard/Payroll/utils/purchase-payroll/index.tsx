...
export const features = [
    ...
    },
    {
        icon: Feature2,
        title: 'Payroll Run',
        description: 'Manage salaries efficiently with automated processes and avoid human errors.',
    },
    {
        icon: Feature3,
        title: 'Leaves & LOP',
        description: 'Streamline leave applications and approvals. Avoid communication gaps.',
    },
    {
        icon: Feature4,
        title: 'Announcement & Alerts',
        description: 'Enable seamless communication and keep your team informed.',
    },
    {
        icon: Feature5,
        title: 'Employee Benefits',
        description:
            'Manage employee perks and benefits. Ensure timely acknowledgment of valuable contributions.',
    },
    {
        icon: Feature6,
        title: 'and More',
