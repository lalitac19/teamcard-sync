...
import BillDetailsForm from '../../../components/forms/BillDetailsForm';
...
describe('BillDetailsForm', () => {
    ...
    it('should render form fields correctly', () => {
        render(
            <Router>
                <BillDetailsForm limitData={mockLimitData} isLoading={false} />
            </Router>
        );

        expect(screen.getByText(/Account Number/i)).toBeInTheDocument();
        expect(screen.getByText(/Account Pin/i)).toBeInTheDocument();
    });

    it('should render loading state when isLoading is true', () => {
        render(
            <Router>
                <BillDetailsForm limitData={mockLimitData} isLoading />
            </Router>
        );
