...
import {
  ...
  SidebarFooter,
  useSidebar,
} from "@src/domains/dashboard/CorporateCard/teamcard/components/ui/sidebar";
import { useCurrentUser } from "@src/domains/dashboard/CorporateCard/teamcard/lib/currentUser";
import { cards as allCards } from "@src/domains/dashboard/CorporateCard/teamcard/lib/mockData";
...
export function AppSidebar() {
  ...
  const accountingActive = !isMember && (location.pathname === "/statement" || location.pathname.startsWith("/accounting") || location.pathname.startsWith("/service-fees"));
                  ...
                  <SidebarMenuItem>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side="right" align="start">
                        ...
                        <DropdownMenuItem onClick={() => navigate("/service-fees")}>
