...
import AssetDocMobileCard from './AssetDocMobileCard';
...
const AssetDocMobileView: FC<AssetDocMobileProps> = ({
    searchText,
    setReloadTable,
    orderCount,
    tableLoading,
...
export default AssetDocMobileView;
