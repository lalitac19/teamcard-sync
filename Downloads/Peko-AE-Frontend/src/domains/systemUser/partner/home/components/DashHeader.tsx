...
const DashHeader = ({ dashboardData, isLoading }: DashHeaderProps) =>
    isLoading ? (
        <>
            <Typography.Text className="text-xl ">Overall Statics</Typography.Text>
        ...
        <Row gutter={[30, 30]} className="mb-10">
            ...
            <Col xs={24} sm={12} md={6} lg={8} className="min-h-10">
                <DetailsCard icon={GMV} amount={dashboardData?.totalRevenue} title="GMV" isAmount />
            </Col>
            <Col xs={24} sm={12} md={6} lg={8} className="min-h-10">
                <DetailsCard
                    isAmount
                    icon={MoneyBackIcon}
                    amount={dashboardData?.totalCashback}
            ...
            <Col xs={24} sm={12} md={6} lg={8} className="min-h-10">
                <DetailsCard
                    ...
                    amount={dashboardData?.totalNetworkShare}
                    title="System Share"
                />
            </Col>
            <Col xs={24} sm={12} md={6} lg={8} className="min-h-10">
                <DetailsCard
                    icon={RegisteredUser}
                    amount={dashboardData?.totalCorporateUsers}
