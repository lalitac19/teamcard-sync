...
import BusinessListingsIcon from '@domains/dashboard/moreServices/assets/icons/BusinessListings.svg';
import RuyaSupportIcon from '@domains/dashboard/moreServices/assets/icons/RuyaSupport.svg';
...
export const moreServices = [
    {
        ...
        title: 'Bank Account',
        status: 'New',
        path: paths.dashboard.bankAccount,
    },
    {
        icon: BusinessListingsIcon,
        title: 'Business Listings',
        status: 'New',
        path: paths.dashboard.businessListings,
    },
    {
        icon: RuyaSupportIcon,
        title: 'Ruya Support',
        status: 'New',
        path: paths.dashboard.ruyaSupport,
    },
    {
        icon: LicenseRenewal,
