...
export default function usePaymentApiForEsr() {
    ...
    const handleCardPaymentRequest = async ({
        ...
        const requestBody = {
            ...
            userId: id,
            userType: role,
            successUrl: `${FRONTEND_BASE_URL}${paths.dashboard.accounting}/${paths.esr.index}/${paths.esr.paymentSuccess}`,
            failureUrl: `${FRONTEND_BASE_URL}${paths.dashboard.accounting}/${paths.esr.index}/${paths.esr.paymentFailure}`,
        };
