...
const adminNotifications: AppNotification[] = [
  {
    ...
    description: "Card limit increases and vendor invoices awaiting your review.",
    time: "2m ago",
    unread: true,
    icon: ClipboardCheck,
    href: "/approvals",
  ...
  {
    id: "a2",
    title: "Available Limit low",
    description: "Available Limit below AED 10,000 — consider topping up.",
    time: "1h ago",
    unread: true,
    icon: Wallet,
    href: "/wallet",
  ...
  },
  {
    ...
    description: "AED 4,820 — DEWA, due in 5 days.",
    time: "Yesterday",
    unread: false,
    icon: FileText,
    href: "/invoices",
...
const memberNotifications: AppNotification[] = [
  ...
  },
  {
    ...
    description: "AED 320 has been reimbursed to your bank account.",
    time: "2h ago",
    unread: true,
    icon: HandCoins,
