...
import {
  ...
  AlertDialogTrigger,
} from "@src/domains/dashboard/CorporateCard/teamcard/components/ui/alert-dialog";
...
const billStatusVariant = (s: Bill["status"]) =>
  s === "paid"
              ...
              <TableBody>
                {bills.map((bill) => (
                  <TableRow key={bill.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline" className={billStatusVariant(bill.status)}>
                        {bill.status}
                      </Badge>
                    </TableCell>
