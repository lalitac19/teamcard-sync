...
import { TableFilters, ALL } from "@src/domains/dashboard/CorporateCard/teamcard/components/TableFilters";
...
const Approvals = () => {
  ...
  // Available headroom in the Corporate Account to grant new/raised allocations.
  ...
  return (
    ...
    >
      <Tabs defaultValue="txn" className="w-full">
        ...
        {/* 5. Card fund requests */}
        <TabsContent value="topup" className="mt-4">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
            <p className="text-xs text-muted-foreground">
              Limit-increase requests submitted by cardholders. On approval, the card's spending limit is raised. Funds are not reserved — all cards share the same wallet pool.
            </p>
            <p className="text-xs">
              <span className="text-muted-foreground">Corporate Account available: </span>
                          ...
                          <TableCell>
                            <div className="flex flex-col gap-1">
                              ...
                              {r.status === "approved" && r.fundingStatus === "insufficient_funds" && (
                                <span className="text-[10px] text-warning">On hold — Corporate Account underfunded</span>
                              )}
