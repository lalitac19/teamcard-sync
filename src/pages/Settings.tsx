      ...
      <Card>
        <CardContent className="space-y-4 p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              After the 3 physical cards included in your free plan, each extra physical card is
              charged as a one-off fee at the time of issuance.
            </p>
          </div>
      ...
      <Card>
        <CardContent className="space-y-4 p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              These fees are configured by our card processor and fetched live via API. They are
              deducted along with the original transaction and shown on your Account Statement.
            </p>
          </div>
