...
import OneKYBIcon from '@assets/icons/OneKYB.svg';
...
export function useNavData() {
    ...
    const sidebarConfig: NavItem[] = useMemo(
        () => [
            ...
            {
                key: paths.dashboard.oneKYB,
                label: NavText('OneKYB', checkRouteIsActive(paths.dashboard.oneKYB), 'new'),
                icon: NavIcon(OneKYBIcon, checkRouteIsActive(paths.dashboard.oneKYB)),
                stringLabel: 'OneKYB',
            },
            {
